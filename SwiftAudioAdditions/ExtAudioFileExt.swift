...
public func ExtAudioFileGetPropertyInfo(inExtAudioFile: ExtAudioFileRef, propertyID inPropertyID: ExtAudioFilePropertyID, size outSize: inout Int, writable outWritable: inout Bool) -> OSStatus {
...
public func ExtAudioFileGetPropertyInfo(inExtAudioFile: ExtAudioFileRef, propertyID inPropertyID: ExtAudioFilePropertyID, size outSize: inout UInt32, writable outWritable: inout Bool) -> OSStatus {
	var ouWritable: DarwinBoolean = false

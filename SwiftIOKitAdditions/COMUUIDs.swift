...
public let kIOHIDDeviceUserClientTypeID: CFUUID = CFUUIDGetConstantUUIDWithBytes(kCFAllocatorDefault,
		0xFA, 0x12, 0xFA, 0x38, 0x6F, 0x1A, 0x11, 0xD4,
		0xBA, 0x0C, 0x00, 0x05, 0x02, 0x8F, 0x18, 0xD5)


public let kIOHIDDeviceInterfaceID: CFUUID = CFUUIDGetConstantUUIDWithBytes(kCFAllocatorDefault,
		0x78, 0xBD, 0x42, 0x0C, 0x6F, 0x14, 0x11, 0xD4,
		0x94, 0x74, 0x00, 0x05, 0x02, 0x8F, 0x18, 0xD5)

public let kIOHIDDeviceInterfaceID121 = CFUUIDGetConstantUUIDWithBytes(kCFAllocatorDefault,
		0x7d, 0xb, 0x51, 0xe, 0x16, 0xd5, 0x11, 0xd7,
		0x9e, 0x9b, 0x0, 0x3, 0x93, 0x99, 0x2e, 0x38)

public let kIOHIDDeviceInterfaceID122: CFUUID = CFUUIDGetConstantUUIDWithBytes(kCFAllocatorDefault,
		0xb7, 0xa, 0xbf, 0x31, 0x16, 0xd5, 0x11, 0xd7,
		0xab, 0x35, 0x0, 0x3, 0x93, 0x99, 0x2e, 0x38)

public let kIOHIDQueueInterfaceID: CFUUID = CFUUIDGetConstantUUIDWithBytes(kCFAllocatorDefault,
		0x81, 0x38, 0x62, 0x9E, 0x6F, 0x14, 0x11, 0xD4,
		0x97, 0x0E, 0x00, 0x05, 0x02, 0x8F, 0x18, 0xD5)

public let kIOHIDOutputTransactionInterfaceID: CFUUID = CFUUIDGetConstantUUIDWithBytes(kCFAllocatorDefault,
...
public var kIOUSBInterfaceUserClientTypeID: CFUUID = CFUUIDGetConstantUUIDWithBytes(kCFAllocatorDefault,

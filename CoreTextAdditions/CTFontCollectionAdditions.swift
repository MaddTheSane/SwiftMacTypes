...
public extension CTFontCollection {
	...
	*///--------------------------------------------------------------------------
	...
	/// - parameter queryDescriptors: An array of font descriptors to use for matching. May be `nil`, in which case the matching descriptors will be `nil`.
	/// - parameter options: The options dictionary. See constant option keys.
	...
	/// - parameter options: The options dictionary. See constant option keys.
	/// - returns: a copy of this font collection augmented by the new font descriptors and options. The new font descriptors are merged with the existing descriptors to create a single set.
	...
	*///--------------------------------------------------------------------------
	...
	///
	/// This getter returns an array of descriptors to be used to query (match) the system font database. The return value is undefined if `CTFontCollectionCreateFromAvailableFonts` was used to create the collection.
	...
	*///--------------------------------------------------------------------------
	...
	/// - returns: An array of `CTFontDescriptor`s matching the criteria of the collection, sorted by the results of the sorting callback function, or `nil` if there are none.
	...
	*///--------------------------------------------------------------------------
	...
	/// - returns: An array containing one value for each descriptor. With `kCTFontCollectionCopyDefaultOptions`, the values will be in the same order as the results from `CTFontCollectionCreateMatchingFontDescriptors` and `NULL` values will be transformed to `nil`. When the `CTFontCollection.CopyOptions.unique` is set, duplicate values will be removed. When `CTFontCollection.CopyOptions.standardSort` is set, the values will be sorted in standard UI order.
	...
	/// - parameter options: Options to alter the return value.
	///
	/// - returns: An array containing one `Dictionary` value for each descriptor mapping the requested attribute names. With `kCTFontCollectionCopyDefaultOptions`, the values will be in the same order as the results from `matchingFontDescriptors()`. When the `CTFontCollection.CopyOptions.unique` is set, duplicate values will be removed. When `CTFontCollection.CopyOptions.standardSort` is set, the values will be sorted in standard UI order.
...
public extension CTMutableFontCollection {
	...
	/// An array of `CTFontDescriptor`. May be `nil` to represent an empty collection, in which case the matching descriptors will also be `nil`.

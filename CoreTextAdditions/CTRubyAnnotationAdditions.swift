...
extension CTRubyAnnotation {
	...
	public static func create(alignment: Alignment, overhang: Overhang, sizeFactor: CGFloat, text: [String?]) -> CTRubyAnnotation {
	...
	/// Using this function is the easiest and most efficient way to
	/// create a ruby annotation object.
	public static func create(alignment: Alignment, overhang: Overhang, sizeFactor: CGFloat, text: (before: String?, after: String?, interCharacter: String?, inline: String?)) -> CTRubyAnnotation {
	...
	public func getText(for position: Position) -> String? {

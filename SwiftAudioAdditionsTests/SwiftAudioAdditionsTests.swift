...
class SwiftAudioAdditionsTests: XCTestCase {
    ...
    func testASBDStringInit() {
		...
		asbd = AudioStreamBasicDescription(fromText: "BEI16@44100,2")
		XCTAssert(asbd != nil, "Invalid asbd format?")
		asbd = AudioStreamBasicDescription(fromText: "BEI16.1@44100:L5")
		XCTAssert(asbd != nil, "Invalid asbd format?")
		asbd = AudioStreamBasicDescription(fromText: "-BEI16@44100,2D")
		XCTAssert(asbd != nil, "Invalid asbd format?")
		asbd = AudioStreamBasicDescription(fromText: "-BEUI16@44100,2D")
		XCTAssert(asbd != nil, "Invalid asbd format?")
		asbd = AudioStreamBasicDescription(fromText: "BEI16@44100,2D")
		XCTAssert(asbd != nil, "Invalid asbd format?")
		...
		XCTAssert(asbd != nil, "Invalid asbd format?")
		asbd = AudioStreamBasicDescription(fromText: "aac/5bE")
		XCTAssert(asbd != nil, "Invalid asbd format?")
    }
	...
	func testInvalidASBDStringInits() {
		...
		XCTAssertEqual(asbd, nil)
		asbd = AudioStreamBasicDescription(fromText: "aa")
		XCTAssertEqual(asbd, nil)
		...
		XCTAssertEqual(asbd, nil)
		asbd = AudioStreamBasicDescription(fromText: "\\x20\\y20")
		XCTAssertEqual(asbd, nil)
		asbd = AudioStreamBasicDescription(fromText: "B")
		XCTAssertEqual(asbd, nil)
		asbd = AudioStreamBasicDescription(fromText: "BE")
		XCTAssertEqual(asbd, nil)
		asbd = AudioStreamBasicDescription(fromText: "BEI16.c@44100,2")
		XCTAssertEqual(asbd, nil)
		asbd = AudioStreamBasicDescription(fromText: "aac/5bEé")
		XCTAssertNil(asbd)
		asbd = AudioStreamBasicDescription(fromText: "aac/5bE,12D")
		XCTAssertNil(asbd)
		asbd = AudioStreamBasicDescription(fromText: "aac/5bE;")
		XCTAssertNil(asbd)
		asbd = AudioStreamBasicDescription(fromText: "aac/5bG")
		XCTAssertNil(asbd)
	}
}
